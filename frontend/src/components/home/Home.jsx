...
const Home = () => {
  ...
  const saveEditCardDialog = async () => {
    try {
      const result = await axios.post(`${Base_Url}/api/saveEditedCard`, {question: dlgQuestion, answer: dlgAnswer, orgQuestion: orgQuestion, orgAnswer: orgAnswer});
      console.log("saveEditCardDialog", "success");
    } catch (error) {
            ...
            <div class="modal-dialog" style={{textAlign: 'left'}}>
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h3 class="modal-title">Edit a fact card</h3>
                </div>
